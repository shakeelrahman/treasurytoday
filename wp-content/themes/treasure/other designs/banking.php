<?php $title="Banking"; include "./layout/header.php"; ?>
<div id="content">
  <section class="banner insights-banner">
      <div class="container py-4">
        <div class="row mx-0">
            <h1 class="text-secondary fw-bold mb-3">Banking</h1>
          <div class="col-xl-3">
           <h2 class="text-primary list_heading">What does digital world mean for banking in Asia?</h2>
          <p class="fst-italic">Even pre-COVID, parts of the Asian banking sector were going through turmoil. When the COVID-19 pandemic hit, businesses and banks alike were thrown into uncertainty. So what exactly has the pandemic done to banking in Asia, what will happen after, and what should treasurers look out for?</p>
          </div>
          <div class="col-xl-6">
        ...
        <ul class="pagination mb-0 py-3 d-flex flex-wrap">        
         <li class="page-item">
          ...
          <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Banking Relationships</a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Bank Selection</a>
         </li>
         <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Industry Analysis</a>
         </li>
         </div>
