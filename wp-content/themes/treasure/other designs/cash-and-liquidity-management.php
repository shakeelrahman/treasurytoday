<?php $title="Cash & Liquidity Management"; include "./layout/header.php"; ?>
<div id="content">
  <section class="banner insights-banner">
      <div class="container py-4">
        <div class="row mx-0">
            <h1 class="text-secondary fw-bold mb-3">Cash & Liquidity Management</h1>
          <div class="col-xl-3">
           <h2 class="text-primary list_heading">Question Answered: China's money market fund landscape</h2>
          <p class="fst-italic">“What does China’s money market fund landscape look like today, and what developments are likely in 2022?”</p>
          </div>
          <div class="col-xl-6">
    ...
    <section class="news my-5">
      <div class="container">
        ...
        <ul class="pagination mb-0 py-3 d-flex flex-wrap">        
         <li class="page-item">
           <a href="" class="page-link border-0">All</a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="" class="page-link border-0">Cash Management</a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="" class="page-link border-0">Financial Planning</a>
         </li>
         <li class="page-item d-none d-md-block">
           <a href="" class="page-link border-0">Liquidity Management</a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="" class="page-link border-0">Payments & Collections</a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="" class="page-link border-0">Working Capital</a>
         </li>
         </div>
