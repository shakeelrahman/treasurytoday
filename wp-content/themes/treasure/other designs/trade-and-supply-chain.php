<?php $title="Trade & Supply Chain"; include "./layout/header.php"; ?>
<div id="content">
  <section class="banner insights-banner">
      <div class="container py-4">
        <div class="row mx-0">
            <h1 class="text-secondary fw-bold mb-3">Trade & Supply Chain</h1>
          <div class="col-xl-3">
           <h2 class="text-primary list_heading">Asia addresses widening trade finance gap</h2>
          <p class="fst-italic">The global trade finance gap - the difference between the need for financing and the actual lending - has dramatically increased since the onset of the pandemic. In Asia, small and medium enterprises are particularly affected, and although technology solutions show promise in addressing their needs, fintech alone cannot plug the widening gap.</p>
          </div>
          <div class="col-xl-6">
