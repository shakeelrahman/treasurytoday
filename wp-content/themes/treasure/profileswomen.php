                    ...
                    <div class="col-md-9 px-0 women-in-treasury">
                        <div class="wit-text-and-menu">
							...
							<div class="page-content"><?php the_content(); ?></div>
                                ...
                                <?php
                                if (have_rows('set_profile_data')) :
                                    while (have_rows('set_profile_data')) : the_row();
                                ?>
                                        <div class="row py-5  border-bottom mx-0">
                                            ...
                                            <div class="col-lg-9 col-md-8 px-md-3 px-0">
                                                <div>
                                                    <h6 class="text-secondary fw-bold mb-3"><?php the_sub_field('profile_name'); ?></h6>
                                                    <h6 class="text-secondary fw-bold mb-3">Published: <span class="fw-normal text-primary"><?php the_sub_field('published_date'); ?></span></h6>
                                                    <p><?php the_sub_field('profile_text'); ?></p>
                                                    <a class="read-more rounded-pill btn text-secondary fw-bold px-4 border-3 border-secondary" href="<?php the_sub_field('profile_link'); ?>">Read article</a>
                                                </div>
                                            </div>
                                        </div>
                                <?php
