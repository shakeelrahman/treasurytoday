<?php
/*
 Template Name: Webinars On Demand
 */
get_header();
if (have_posts()) :
...
<div id="content">
   <section class="womens">
       <div class="container pb-5 pt-3">
         ...
         <li class="page-item">
             <a href="<?php echo home_url(); ?>/webinars/" class="page-link border-0">Upcoming </a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="<?php echo home_url(); ?>/on-demand/" class="page-link border-0">On demand</a>
         </li>
      </ul>
     </nav>
...
if( have_rows('add_webinars') ):
    while( have_rows('add_webinars') ) : the_row();
        $imagelink = get_sub_field('webinar_link');
?>
<div class="col-md-4">
    <a href="<?php echo $imagelink['url']; ?>">
    <img alt="<?php the_sub_field('webinar_title') ?>" src="<?php the_sub_field('webinar_image') ?>" class="img-fluid">
    </a>
</div>                        
<div class="ondemandwebinar col-md-8">
