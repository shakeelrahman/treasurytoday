...
<div id="content">
  <section class="banner">
    <div class="container">
      <div class="row mx-0 border-bottom py-4">
        ...
        <div class="col-md-6">
            <img class="img-fluid border-top border-5 border-secondary" src="<?php echo $url; ?>" alt="FP Main Banner" width="600">
        </div>
  ...
  <section class="add-1">
    <div class="container">
      <div class="row mx-0 border-bottom py-4">
        ...
        ?>
            <div class="col-md-3 <?php if ($count) {
                                    echo '';
                                  } ?>  pb-4 border-end bor-col">
        ...
        <div class="col-md-3 offset-md-0 offset-sm-3 col-sm-6">
      ...
      <div class="row mx-0 border-bottom pb-3">
        ...
        if ($tec_featured_posts) :
          foreach ($tec_featured_posts as $post) :
            ...
            $categories = get_the_category(get_the_ID());
            if (!empty($categories)) {
              $setpermalinkcat = '<a class="text-secondary small" href="' . esc_url(get_category_link($categories[0]->term_id)) . '">' . esc_html($categories[0]->name) . '</a>';
            }
            if ($col_1) :
        ?>
    ...
    <div class="container">
      <div class="row mx-0 border-bottom py-4">
        ...
        ?>
          ...
          ?>
            <div class="col-md-3 <?php if ($firsttabclass) echo ''; ?>  pb-4 border-end bor-col">
              <div class="d-flex im-text">
                <a class="col-md-12 col-3 position-relative" href="<?php the_permalink(); ?>">
                  <?php //the_post_thumbnail('full', array('class' => 'img-fluid'));   
        ...
        <div class="col-md-3 offset-md-0 col-sm-6 offset-sm-3">
          <?php
    ...
    <div class="container py-5">
      ...
      <div class="row mx-0">
        <div class="col-md-4 ps-md-0">
          ...
          <header>
            <?php
            $vidoepostcat = get_the_category(get_field('page_to_be_displayed_below_1'));
            $i = 0;
            foreach ($vidoepostcat as $c) {
              $cats[] = array('name' => $c->name, 'slug' => $c->slug);
              if ($i > 0)
                echo '-';
            ?>
              <a class="text-secondary small" href="<?php echo esc_url(get_category_link($c->term_id)); ?>">
                <?php
                echo $c->name;
                ?>
              </a>
        ...
        <div class="col-md-4 ps-md-0">
          ...
          <header>
            <?php
            $vidoepostcat = get_the_category(get_field('page_to_be_displayed_below_2'));
            $i = 0;
            foreach ($vidoepostcat as $c) {
              $cats[] = array('name' => $c->name, 'slug' => $c->slug);
              if ($i > 0)
        ...
        <div class="col-md-4 ps-md-0">
          ...
          <header>
            <?php
            $vidoepostcat = get_the_category(get_field('page_to_be_displayed_below_3'));
            $i = 0;
            foreach ($vidoepostcat as $c) {
              $cats[] = array('name' => $c->name, 'slug' => $c->slug);
              if ($i > 0)
    ...
    <div class="container">
      <div class="row mx-0 py-4 border-bottom">
        ...
        ?>
          ...
          ?>
            <div class="col-md-3 <?php if ($firsttabclass) echo 'ps-md-0'; ?>  pb-4 border-end bor-col">
              <div class="d-flex im-text">
                <a class="col-md-12 col-3 position-relative" href="<?php the_permalink(); ?>">
                  <?php //the_post_thumbnail('full', array('class' => 'img-fluid'));   ?>
                    <?php 
  ...
  <section class="womens py-5 bg-primary">
    <div class="container">
      ...
      <div class="row mx-0">
        ...
        ?>
            ...
            ?>
              <div class="col-md-6 pb-4">
                <a href="<?php the_permalink(); ?>">
                  <?php the_post_thumbnail('full', array('class' => 'img-fluid pb-3 border-5 border-top border-secondary'));   ?></a>
                <?php echo $setpermalinkcat; ?>
                <span class="text-muted small">- <?php echo meks_time_ago(); ?></span>
                <a href="<?php the_permalink(); ?>">
                  <h2 class="black-link pe-3"><?php the_title(); ?></h2>
    ...
    <div class="container py-5">
      ...
      <div class="row mx-0">
        <div class="col-md-4 ps-md-0">
          ...
          <header>
            <?php
            $vidoepostcat = get_the_category(get_field('lr_page_to_be_displayed_below_1'));
            $i = 0;
            foreach ($vidoepostcat as $c) {
              $cats[] = array('name' => $c->name, 'slug' => $c->slug);
              if ($i > 0)
        ...
        <div class="col-md-4 ps-md-0">
          ...
          <header>
            <?php
            $vidoepostcat = get_the_category(get_field('lr_page_to_be_displayed_below_2'));
            $i = 0;
            foreach ($vidoepostcat as $c) {
              $cats[] = array('name' => $c->name, 'slug' => $c->slug);
              if ($i > 0)
        ...
        <div class="col-md-4 ps-md-0">
          ...
          <header>
            <?php
            $vidoepostcat = get_the_category(get_field('lr_page_to_be_displayed_below_3'));
            $i = 0;
            foreach ($vidoepostcat as $c) {
              $cats[] = array('name' => $c->name, 'slug' => $c->slug);
              if ($i > 0)
