<?php $title="Perspectives"; include "./layout/header.php"; ?>
<div id="content">
  <section class="banner insights-banner">
      <div class="container py-4">
        <div class="row mx-0">
            <h1 class="text-secondary fw-bold mb-3">Perspectives</h1>
          <div class="col-xl-3">
           <h2 class="text-primary list_heading">The view in 2022</h2>
          <p class="fst-italic">As a tumultuous year draws to a close, Treasury Today Group considers some of the existing and emerging geopolitical risks corporates will have to manage in 2022.</p>
          </div>
          <div class="col-xl-6">
        ...
        <ul class="pagination mb-0 py-3 d-flex flex-wrap">        
         <li class="page-item">
          ...
          <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Market Insight</a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Opinions</a>
         </li>
         <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Profiles</a>
         </li>
         </div>
