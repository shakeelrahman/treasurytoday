<?php $title="Technology"; include "./layout/header.php"; ?>
<div id="content">
  <section class="banner insights-banner">
      <div class="container py-4">
        <div class="row mx-0">
            <h1 class="text-secondary fw-bold mb-3">Technology</h1>
          <div class="col-xl-3">
           <h2 class="text-primary list_heading">First steps to digitisation</h2>
          <p class="fst-italic">Digital transformation projects have accelerated during the COVID-19 pandemic as organisations face rising digital commerce volumes and remote working practices. By assessing business practices and setting a clear target, companies can stay ahead of the digital curve.</p>
          </div>
          <div class="col-xl-6">
        ...
        <ul class="pagination mb-0 py-3 d-flex flex-wrap">        
         <li class="page-item">
          ...
          <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Connectivity</a>
         </li>
          <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Cybersecurity</a>
         </li>
         <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Emerging Technology</a>
         </li>
         <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Fintech</a>
         </li>
         <li class="page-item d-none d-md-block">
           <a href="javascript: void(0)" class="page-link border-0">Treasury Systems</a>
         </li>
         </div>
