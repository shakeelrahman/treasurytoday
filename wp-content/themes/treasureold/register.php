...
"> Sign in with LinkedIn</a>
         ...
         <form id="ajax-registration-form" action="#">
           <div class="form-group mb-3">
             <input type="text" class="form-control py-2" placeholder="First Name *" name="rfname" id="rfname" required>
           </div>
           <div class="form-group mb-3">
             <input type="text" class="form-control py-2" placeholder="Last Name *" name="rlname" id="rlname" required>
           </div>
           <div class="form-group mb-3">
             <input type="text" class="form-control py-2" placeholder="Company Name *" name="rcompanyname" id="rcompanyname" required>
           </div>
           <div class="form-group mb-3">
         ...
         <!--          <div class="signuptesting">test</div>-->
