                ...
                <div class="row mx-0">
                    <div class="col-md-9 px-0 women-in-treasury">
                        <div class="wit-text-and-menu">
                            ...
                            <div class="profiles-listing">
                                <?php
                                $the_query = new WP_Query(array(
                                    'post_type' => 'ttwomen',
                                    'tax_query' => array(
                                        array(
                                            'taxonomy' => 'ttomen_category',
                                            'field' => 'slug',
                                            'terms' => 'forums',
                                        )
                                    ),
                                ...
                                while ($the_query->have_posts()) :
                                    $the_query->the_post();
                                ?>
                                    <div class="row py-5  border-bottom mx-0">
                                        <div class="col-lg-3 col-md-4 px-0">
                                            <!--                                                <img style="max-width:200px;" class="img-fluid mb-3" src="<?php the_sub_field('profile_image'); ?>" />-->
                                            <?php the_post_thumbnail('post-thumbnail', ['class' => 'img-fluid mb-3', 'title' => 'Feature image']); ?>
                                        </div>
                                        <div class="col-lg-9 col-md-8 px-md-3 px-0">
                                            <div>
                                                <h6 class="text-secondary fw-bold mb-3"><?php the_title(); ?></h6>
                                                <h6 class="text-secondary fw-bold mb-3">Date: <span class="text-primary fw-normal"><?php the_field('date_of_forum'); ?></span></h6>
                                                <h6 class="text-primary fw-bold mb-1"><?php the_field('venue_of_forum'); ?></h6>
                                                <?php the_excerpt(); ?>
                                                <a class="read-more rounded-pill btn text-secondary fw-bold px-4 border-3 border-secondary" href="<?php the_permalink(); ?>">Find out more</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php
                                ...
                                wp_reset_postdata();
                                ?>
                            </div> <!-- Profiles Listing Div Ends Here -->
                        </div>
                    </div>
                </div>
            </div>
